...
assignin('base','evaluationChannels',evaluationChannels);
...
disp('-----Method 1: Unusually high or low amplitude (using robust std)---------------');
...
disp('-----Method 2: Compute the SNR (based on Christian Kothes clean_channels)');
...
disp('-----Method 3: Global correlation criteria (from Nima Bigdely-Shamlo)------------');
...
disp('-----Method 4: Ransac correlation (may not be performed)------------');
